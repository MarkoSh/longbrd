(function () {
    ...
    var oc = function () {
        ...
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j47", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(oc() + "/ga", a.join("&"), ua))
    };
    var h = function (a) {
    ...
    var Sd = function (a) {
        if (!a.get("dcLoaded") && "cookie" == a.get(ac)) {
            ...
            Pd(b, a);
            Qd(b, a);
            a.get(b.U) && (a.set(Md, 1, !0), a.set(gd, oc() + "/ga", !0))
        }
    };
    var Lc = function () {
