...
if (!function (t) {
        ...
        t.fn.bxSlider = function (o) {
            ...
            var n = {}, s = this, r = t(window).width(), a = t(window).height(), l = function () {
                n.settings = t.extend({}, e, o), n.settings.slideWidth = parseInt(n.settings.slideWidth), n.children = s.children(n.settings.slideSelector), n.children.length < n.settings.minSlides && (n.settings.minSlides = n.children.length), n.children.length < n.settings.maxSlides && (n.settings.maxSlides = n.children.length), n.settings.randomStart && (n.settings.startSlide = Math.floor(Math.random() * n.children.length)), n.active = {index: n.settings.startSlide}, n.carousel = n.settings.minSlides > 1 || n.settings.maxSlides > 1 ? !0 : !1, n.carousel && (n.settings.preloadImages = "all"), n.minThreshold = n.settings.minSlides * n.settings.slideWidth + (n.settings.minSlides - 1) * n.settings.slideMargin, n.maxThreshold = n.settings.maxSlides * n.settings.slideWidth + (n.settings.maxSlides - 1) * n.settings.slideMargin, n.working = !1, n.controls = {}, n.interval = null, n.animProp = "vertical" === n.settings.mode ? "top" : "left", n.usingCSS = n.settings.useCSS && "fade" !== n.settings.mode && function () {
                        var t = document.createElement("div"), e = ["WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"];
                        for (var i in e)if (void 0 !== t.style[e[i]])return n.cssPrefix = e[i].replace("Perspective", "").toLowerCase(), n.animProp = "-" + n.cssPrefix + "-transform", !0;
                        return !1
                ...
                s.wrap('<div class="' + n.settings.wrapperClass + '"><div class="bx-viewport"></div></div>'), n.viewport = s.parent(), n.loader = t('<div class="bx-loading" />'), n.viewport.prepend(n.loader), s.css({
                    ...
                    overflow: "hidden",
                    position: "relative"
                }), n.viewport.parent().css({maxWidth: p()}), n.settings.pager || n.settings.controls || n.viewport.parent().css({margin: "0 auto 0px"}), n.children.css({
                ...
                } else o = n.children.eq(n.active.index); else o = n.children;
                ...
                var t = 1;
                if ("horizontal" === n.settings.mode && n.settings.slideWidth > 0)if (n.viewport.width() < n.minThreshold)t = n.settings.minSlides; else if (n.viewport.width() > n.maxThreshold)t = n.settings.maxSlides; else {
                ...
                var t = 0;
                if (n.settings.moveSlides > 0)if (n.settings.infiniteLoop)t = Math.ceil(n.children.length / v()); else for (var e = 0, i = 0; e < n.children.length;)++t, e = i + m(), i += n.settings.moveSlides <= m() ? n.settings.moveSlides : m(); else t = Math.ceil(n.children.length / m());
                return t
            }, v = function () {
                ...
                var e = 0;
                if ("next" === n.settings.autoDirection)s.append(n.children.clone().addClass("bx-clone")); else {
                    s.prepend(n.children.clone().addClass("bx-clone"));
                    var i = n.children.first().position();
                    e = "horizontal" === n.settings.mode ? -i.left : -i.top
                }
                if (y(e, "reset", 0), n.settings.pager = !1, n.settings.controls = !1, n.settings.autoControls = !1, n.settings.tickerHover)if (n.usingCSS) {
                ...
                var o = "horizontal" === n.settings.mode ? -e.left : -e.top, r = "horizontal" === n.settings.mode ? -i.left : -i.top, a = {resetValue: r};
                y(o, "ticker", speed, a)
            }, D = function (e) {
                var i = t(window), o = {top: i.scrollTop(), left: i.scrollLeft()};
                ...
                if (n.controls.el.addClass("disabled"), n.working)t.preventDefault(), n.controls.el.removeClass("disabled"); else {
                ...
                if (n.initialized)if (n.working)window.setTimeout(q, 10); else {
            ...
            return s.goToSlide = function (e, i) {
                if (!n.working && n.active.index !== e) {
                    ...
                    if (n.active.last = n.active.index >= g() - 1, (n.settings.pager || n.settings.pagerCustom) && M(n.active.index), n.settings.controls && A(), "fade" === n.settings.mode)n.settings.adaptiveHeight && n.viewport.height() !== u() && n.viewport.animate({height: u()}, n.settings.adaptiveHeightSpeed), n.children.filter(":visible").fadeOut(n.settings.speed).css({zIndex: 0}), n.children.eq(n.active.index).css("zIndex", n.settings.slideZIndex + 1).fadeIn(n.settings.speed, function () {
                        t(this).css("zIndex", n.settings.slideZIndex), $()
                    }); else {
                        n.settings.adaptiveHeight && n.viewport.height() !== u() && n.viewport.animate({height: u()}, n.settings.adaptiveHeightSpeed);
                        var r = 0, a = {left: 0, top: 0}, l = null;
                        if (!n.settings.infiniteLoop && n.carousel && n.active.last)if ("horizontal" === n.settings.mode)l = n.children.eq(n.children.length - 1), a = l.position(), r = n.viewport.width() - l.outerWidth(); else {
                        ...
                        } else if ("next" === i && 0 === n.active.index)a = s.find("> .bx-clone").eq(n.settings.maxSlides).position(), n.active.last = !1; else if (e >= 0) {
                            var h = e * v();
        ...
        }(), d = c("transform"), h = t("<div />", {style: "background:#fff"}).css("background-position-x") !== o, u = h ? function (t, e, i) {
            ...
            return this.each(function () {
                var e = t(this), o = i, n = function () {
                    ...
                    for (var r = (/^[0-9]+$/.test(n), /^[0-9]+\.[0-9]+$/.test(n)), a = r ? (n.split(".")[1] || []).length : 0, l = i; l >= 1; l--) {
                        ...
                        if (r && (c = parseFloat(n / i * l).toFixed(a)), s)for (; /(\d+)(\d{3})/.test(c.toString());)c = c.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                        t.unshift(c)
                    }
...
if (+function (t) {
        ...
        i.VERSION = "3.3.4", i.TRANSITION_DURATION = 150, i.prototype.show = function () {
            ...
            if (o || (o = e.attr("href"), o = o && o.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
                var n = i.find(".active:last a"), s = t.Event("hide.bs.tab", {relatedTarget: e[0]}), r = t.Event("show.bs.tab", {relatedTarget: n[0]});
        ...
        "use strict";
        var i, o = t.document, n = t.Modernizr, s = function (t) {
            return t.charAt(0).toUpperCase() + t.slice(1)
        }, r = "Moz Webkit O Ms".split(" "), a = function (t) {
            var e, i = o.documentElement.style;
            if ("string" == typeof i[t])return t;
            t = s(t);
            for (var n = 0, a = r.length; a > n; n++)if (e = r[n] + t, "string" == typeof i[e])return e
        }, l = a("transform"), c = a("transitionProperty"), d = {
            csstransforms: function () {
                return !!l
            }, csstransforms3d: function () {
                var t = !!a("perspective");
                if (t) {
                    var i = " -o- -moz- -ms- -webkit- -khtml- ".split(" "), o = "@media (" + i.join("transform-3d),(") + "modernizr)", n = e("<style>" + o + "{#modernizr{height:3px}}</style>").appendTo("head"), s = e('<div id="modernizr" />').appendTo("html");
        ...
        if (n)for (i in d)n.hasOwnProperty(i) || n.addTest(i, d[i]); else {
        ...
        if (n.csstransforms) {
            var p = n.csstransforms3d ? {
                ...
                var n, s, r = e.data(t, "isoTransform") || {}, a = {}, c = {};
                a[i] = o, e.extend(r, a);
                for (n in r)s = r[n], c[n] = p[n](s);
                var d = c.translate || "", h = c.scale || "", u = d + h;
        ...
        var v, w = e.event, y = e.event.handle ? "handle" : "dispatch";
        ...
        e.Isotope.settings = {
            ...
            _create: function (t) {
                ...
                var e = this.options.itemSelector, i = e ? t.filter(e).add(t.find(e)) : t, o = {position: "absolute"};
                ...
                if (!e)return t;
                var i = this.options.hiddenClass, o = "." + i, n = t.filter(o), s = n;
                if ("*" !== e) {
                    s = n.filter(e);
                ...
                var o, n, s = this, r = this.options.getSortData;
                t.each(function () {
                    o = e(this), n = {};
                ...
                var t = this.options.sortBy, e = this._getSorter, i = this.options.sortAscending ? 1 : -1, o = function (o, n) {
                    var s = e(o, t), r = e(n, t);
                ...
                var o, s, r, a, l = this.isLaidOut && this.isUsingJQueryAnimation ? "animate" : "css", c = this.options.animationOptions, d = this.options.onLayout;
                if (s = function (t, e) {
                        e.$el[l](e.style, c)
                    ...
                    var h = !1, u = [i, d, c.complete], p = this;
                    if (r = !0, a = function () {
                            if (!h) {
                                for (var e, i = 0, o = u.length; o > i; i++)e = u[i], "function" == typeof e && e.call(p.element, t, p);
                                h = !0
                            }
                        }, this.isUsingJQueryAnimation && "animate" === l)c.complete = a, r = !1; else if (n.csstransitions) {
                ...
                var e, i = this.options.layoutMode, o = t ? "rowHeight" : "columnWidth", n = t ? "height" : "width", r = t ? "rows" : "cols", a = this.element[n](), l = this.options[i] && this.options[i][o] || this.$filteredAtoms["outer" + s(n)](!0) || a;
                e = Math.floor(a / l), e = Math.max(e, 1), this[i][r] = e, this[i][o] = l
            }, _checkIfSegmentsChanged: function (t) {
                var e = this.options.layoutMode, i = t ? "rows" : "cols", o = this[e][i];
                ...
                var i = this, o = i.masonry;
                t.each(function () {
                    var t = e(this), n = Math.ceil(t.outerWidth(!0) / o.columnWidth);
                    if (n = Math.min(n, o.cols), 1 === n)i._masonryPlaceBrick(t, o.colYs); else {
                        var s, r, a = o.cols + 1 - n, l = [];
                        for (r = 0; a > r; r++)s = o.colYs.slice(r, r + n), l[r] = Math.max.apply(Math, s);
                        i._masonryPlaceBrick(t, l)
                    }
                })
            }, _masonryPlaceBrick: function (t, e) {
                for (var i = Math.min.apply(Math, e), o = 0, n = 0, s = e.length; s > n; n++)if (e[n] === i) {
                    o = n;
                    break
                }
                var r = this.masonry.columnWidth * o, a = i;
                this._pushPosition(t, r, a);
                var l = i + t.outerHeight(!0), c = this.masonry.cols + 1 - s;
                ...
                var i = this, o = this.element.width(), n = this.fitRows;
                t.each(function () {
                    var t = e(this), s = t.outerWidth(!0), r = t.outerHeight(!0);
                ...
                var i = this, o = this.cellsByRow;
                t.each(function () {
                    var t = e(this), n = o.index % o.cols, s = Math.floor(o.index / o.cols), r = (n + .5) * o.columnWidth - t.outerWidth(!0) / 2, a = (s + .5) * o.rowHeight - t.outerHeight(!0) / 2;
                ...
                var i = this, o = i.masonryHorizontal;
                t.each(function () {
                    var t = e(this), n = Math.ceil(t.outerHeight(!0) / o.rowHeight);
                    if (n = Math.min(n, o.rows), 1 === n)i._masonryHorizontalPlaceBrick(t, o.rowXs); else {
                        var s, r, a = o.rows + 1 - n, l = [];
                ...
                var r = i, a = this.masonryHorizontal.rowHeight * o;
                this._pushPosition(t, r, a);
                var l = i + t.outerWidth(!0), c = this.masonryHorizontal.rows + 1 - s;
                ...
                var i = this, o = this.element.height(), n = this.fitColumns;
                t.each(function () {
                    var t = e(this), s = t.outerWidth(!0), r = t.outerHeight(!0);
                ...
                var i = this, o = this.cellsByColumn;
                t.each(function () {
                    var t = e(this), n = Math.floor(o.index / o.rows), s = o.index % o.rows, r = (n + .5) * o.columnWidth - t.outerWidth(!0) / 2, a = (s + .5) * o.rowHeight - t.outerHeight(!0) / 2;
                    i._pushPosition(t, r, a), o.index++
                })
            ...
            var n = this, s = n.find("img").add(n.filter("img")), r = s.length, a = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==", l = [];
        ...
        t.fn.fitVids = function (e) {
            var i = {customSelector: null}, o = document.createElement("div"), n = document.getElementsByTagName("base")[0] || document.getElementsByTagName("script")[0];
        ...
        var h = window.MutationObserver || window.WebKitMutationObserver || !1, u = {
            ...
            if (p)return p;
            var t = document.createElement("DIV"), e = {haspointerlock: "pointerLockElement" in document || "mozPointerLockElement" in document || "webkitPointerLockElement" in document};
            ...
            for (var i = ["transform", "msTransform", "webkitTransform", "MozTransform", "OTransform"], o = 0; o < i.length; o++)if ("undefined" != typeof t.style[i[o]]) {
                e.trstyle = i[o];
                break
            }
            ...
            for (var i = "transition webkitTransition MozTransition OTransition OTransition msTransition KhtmlTransition".split(" "), n = " -webkit- -moz- -o- -o -ms- -khtml-".split(" "), s = "transitionend webkitTransitionEnd transitionend otransitionend oTransitionEnd msTransitionEnd KhtmlTransitionEnd".split(" "), o = 0; o < i.length; o++)if (i[o] in t.style) {
            ...
            t:{
                for (i = ["-moz-grab", "-webkit-grab", "grab"], (e.ischrome && !e.ischrome22 || e.isie) && (i = []), o = 0; o < i.length; o++)if (n = i[o], t.style.cursor = n, t.style.cursor == n) {
                    i = n;
                    break t
                }
            ...
            function v(t, e, i) {
                ...
                if (0 == t.deltaMode ? (o = -Math.floor(t.deltaX * (w.opt.mousescrollstep / 54)), n = -Math.floor(t.deltaY * (w.opt.mousescrollstep / 54))) : 1 == t.deltaMode && (o = -Math.floor(t.deltaX * w.opt.mousescrollstep), n = -Math.floor(t.deltaY * w.opt.mousescrollstep)), e && w.opt.oneaxismousemode && 0 == o && n && (o = n, n = 0), o && (w.scrollmom && w.scrollmom.stop(), w.lastdeltax += o, w.debounced("mousewheelx", function () {
                    ...
                    if (w.opt.nativeparentscrolling && i && !w.ispage && !w.zoomactive)if (0 > n) {
            ...
            if (this.version = "3.5.4", this.name = "nicescroll", this.me = c, this.opt = {
                    doc: t("body"),
                    win: !1
                }, t.extend(this.opt, u), this.opt.snapbackspeed = 80, r)for (var y in w.opt)"undefined" != typeof r[y] && (w.opt[y] = r[y]);
            ...
            this.ishwscroll = (this.canhwscroll = b.hastransform && w.opt.hwacceleration) && w.haswrapper, this.istouchcapable = !1, b.cantouch && b.ischrome && !b.isios && !b.isandroid && (this.istouchcapable = !0, b.cantouch = !1), b.cantouch && b.ismozilla && !b.isios && !b.isandroid && (this.istouchcapable = !0, b.cantouch = !1), w.opt.enablemouselockapi || (b.hasmousecapture = !1, b.haspointerlock = !1), this.delayed = function (t, e, i, o) {
                ...
                } : n && n.tt || (w.delaylist[t] = {last: s, tt: 0}, setTimeout(function () {
                    e.call()
                }, 0))))
            ...
            this.getOffset = function () {
                ...
                if (b.hasmstouch && w.css(w.ispage ? t("html") : w.win, {"-ms-touch-action": "none"}), w.zindex = "auto", w.zindex = w.ispage || "auto" != w.opt.zindex ? w.opt.zindex : d() || "auto", !w.ispage && "auto" != w.zindex && w.zindex > s && (s = w.zindex), w.isie && 0 == w.zindex && "auto" == w.opt.zindex && (w.zindex = "auto"), !w.ispage || !b.cantouch && !b.isieold && !b.isie9mobile) {
                    var n = w.docscroll;
                    w.ispage && (n = w.haswrapper ? w.win : w.doc), b.isie9mobile || w.css(n, {"overflow-y": "hidden"}), w.ispage && b.isie7 && ("BODY" == w.doc[0].nodeName ? w.css(t("html"), {"overflow-y": "hidden"}) : "HTML" == w.doc[0].nodeName && w.css(t("body"), {"overflow-y": "hidden"})), b.isios && !w.ispage && !w.haswrapper && w.css(t("body"), {"-webkit-overflow-scrolling": "touch"});
                    ...
                    if (a.append(r), a.width = Math.max(parseFloat(w.opt.cursorwidth), r.outerWidth()) + w.opt.railpadding.left + w.opt.railpadding.right, a.css({
                        ...
                        w.css(n, {"overflow-x": "hidden"}), r = t(document.createElement("div")), r.css({
                            position: "relative",
                            top: 0,
                    ...
                    if (w.ispage ? (a.css({
                            ...
                            top: "0px",
                            height: "100%"
                        }), a.css(a.align ? {right: "0px"} : {left: "0px"}), w.body.append(a), w.railh && (f.css({
                            position: "fixed",
                            left: "0px",
                            width: "100%"
                        }), f.css(f.align ? {bottom: "0px"} : {top: "0px"}), w.body.append(f))) : (w.ishwscroll ? ("static" == w.win.css("position") && w.css(w.win, {position: "relative"}), n = "HTML" == w.win[0].nodeName ? w.body : w.win, w.zoom && (w.zoom.css({
                            position: "absolute",
                            top: 1,
                            right: 0,
                        ...
                        if (b.cantouch || w.istouchcapable || w.opt.touchbehavior || b.hasmstouch) {
                            w.scrollmom = new g(w), w.ontouchstart = function (e) {
                                ...
                                if (w.hasmoving = !1, !w.locked) {
                                    if (b.hasmstouch)for (var i = e.target ? e.target : !1; i;) {
                                    ...
                                    if (!("clientX" in e) && "changedTouches" in e && (e.clientX = e.changedTouches[0].clientX, e.clientY = e.changedTouches[0].clientY), w.forcescreen && (o = e, e = {original: e.original ? e.original : e}, e.clientX = o.screenX, e.clientY = o.screenY), w.rail.drag = {
                                            x: e.clientX,
                                            y: e.clientY,
                                            sx: w.scroll.x,
                                            sy: w.scroll.y,
                            ...
                            w.ontouchmove = function (e, i) {
                                ...
                                if (w.rail.drag && 2 == w.rail.drag.pt) {
                                    ...
                                    if (w.hasmoving = !0, w.preventclick && !w.preventclick.click && (w.preventclick.click = w.preventclick.tg.onclick || !1, w.preventclick.tg.onclick = w.onpreventclick), e = t.extend({original: e}, e), "changedTouches" in e && (e.clientX = e.changedTouches[0].clientX, e.clientY = e.changedTouches[0].clientY), w.forcescreen) {
                                        var o = e;
                                        e = {original: e.original ? e.original : e}, e.clientX = o.screenX, e.clientY = o.screenY
                                    }
                                    if (o = ofy = 0, m && !i) {
                                    ...
                                    if (o = !1, w.rail.drag.dl)o = !0, "v" == w.rail.drag.dl ? c = w.rail.drag.sl : "h" == w.rail.drag.dl && (l = w.rail.drag.st); else {
                        ...
                        if (w.onmousedown = function (t, e) {
                                if (!w.rail.drag || 1 == w.rail.drag.pt) {
                                    ...
                                    var i = w.getTarget(t);
                                    return !w.ispage && b.hasmousecapture && i.setCapture(), w.isiframe && !b.hasmousecapture && (w.saved.csspointerevents = w.doc.css("pointer-events"), w.css(w.doc, {"pointer-events": "none"})), w.hasmoving = !1, w.cancelEvent(t)
                                }
                        ...
                        }, w.opt.grabcursorenabled && b.cursorgrabvalue && (w.css(w.ispage ? w.doc : w.win, {cursor: b.cursorgrabvalue}), w.css(w.rail, {cursor: b.cursorgrabvalue})); else {
                            var v = function (t) {
                                if (w.selectiondrag) {
                                    if (t) {
                        ...
                        b.hasmstouch && (w.css(w.rail, {"-ms-touch-action": "none"}), w.css(w.cursor, {"-ms-touch-action": "none"}), w.bind(w.win, "MSPointerDown", w.ontouchstart), w.bind(document, "MSPointerUp", w.ontouchend), w.bind(document, "MSPointerMove", w.ontouchmove), w.bind(w.cursor, "MSGestureHold", function (t) {
                            t.preventDefault()
                            ...
                            w.onmousedown(t, !0)
                        }), w.bind(w.cursorh, "mouseup", w.onmouseup)), (w.opt.cursordragontouch || !b.cantouch && !w.opt.touchbehavior) && (w.rail.css({cursor: "default"}), w.railh && w.railh.css({cursor: "default"}), w.jqbind(w.rail, "mouseenter", function () {
                            ...
                            w.rail.active = !1, w.rail.drag || w.hideCursor()
                        }))), w.opt.enablemousewheel && (w.isiframe || w.bind(b.isie && w.ispage ? document : w.win, "mousewheel", w.onmousewheel), w.bind(w.rail, "mousewheel", w.onmousewheel), w.railh && w.bind(w.railh, "mousewheel", w.onmousewheelhr)), !w.ispage && !b.cantouch && !/HTML|^BODY/.test(w.win[0].nodeName) && (w.win.attr("tabindex") || w.win.attr({tabindex: o++}), w.jqbind(w.win, "focus", function (t) {
                    ...
                    w.onAttributeChange = function () {
                        ...
                        t.forEach(function (t) {
                            if (0 < t.removedNodes.length)for (var e in t.removedNodes)if (t.removedNodes[e] == w.win[0])return w.remove()
                        })
                ...
                if (!w.zoomactive) {
                    ...
                    return w.zoomrestore.style.width = w.win.css("width"), w.zoomrestore.style.height = w.win.css("height"), w.zoomrestore.padding = {
                        ...
                        "z-index": s + 100,
                        margin: "0px"
                    }), o = w.win.css("backgroundColor"), ("" == o || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(o)) && w.win.css("backgroundColor", "#fff"), w.rail.css({"z-index": s + 101}), w.zoom.css({"z-index": s + 102}), w.zoom.css("backgroundPosition", "0px -18px"), w.resizeZoom(), w.onzoomin && w.onzoomin.call(w), w.cancelEvent(e)
                }
            }, this.doZoomOut = function (e) {
                return w.zoomactive ? (w.zoomactive = !1, w.win.css("margin", ""), w.win.css(w.zoomrestore.style), b.isios4 && t(window).scrollTop(w.zoomrestore.scrollTop), w.rail.css({"z-index": w.zindex}), w.zoom.css({"z-index": w.zindex}), w.zoomrestore = !1, w.zoom.css("backgroundPosition", "0px 0px"), w.onResize(), w.onzoomout && w.onzoomout.call(w), w.cancelEvent(e)) : void 0
        ...
        $(".counter").counterUp({delay: 10, time: 3e3}), $(".image-popup-vertical-fit").magnificPopup({
            type: "image",
            gallery: {enabled: !0}
        });
...
!function () {
    ...
    }, i = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeline", "timelineEnd", "timeStamp", "trace", "warn"], o = i.length, n = window.console = window.console || {}; o--;)t = i[o], n[t] || (n[t] = e)
}();